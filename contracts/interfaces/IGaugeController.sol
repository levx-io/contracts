...
interface IGaugeController {
    ...
    function gaugeTypeNames(int128 type_id) external view returns (string memory);

    function gauges(int128 type_id) external view returns (address);
    ...
    function pointsSum(int128 type_id, uint256 time) external view returns (uint256 bias, uint256 slope);

    function timeSum(int128 type_id) external view returns (uint256 last_scheduled_time);
    ...
    function pointsTypeWeight(int128 type_id, uint256 time) external view returns (uint256 type_weight);

    function timeTypeWeight(int128 type_id) external view returns (uint256 last_scheduled_time);
